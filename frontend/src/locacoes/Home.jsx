        ...
        <div className="min-h-screen bg-base text-slate-200 font-sans">
            ...
            <main className="p-4 max-w-lg mx-auto space-y-8">
                ...
                <section className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <a
                            href="/locacoes"
                            className="text-xs text-blue-400 uppercase font-bold cursor-pointer hover:text-blue-300"
                        >
                            Ver todas
                        </a>
                    </div>
                ...
                <section className="space-y-4 pb-10">
                    ...
                    <div className="bg-base p-4 rounded-2xl border border-white/20 shadow-xl">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex gap-1">
                                <button
                                    ...
                                    className="p-2 hover:bg-base rounded-lg text-white/70"
                                >
                                    {"<"}
                                </button>
                                <button
                        ...
                        <div className="grid grid-cols-7 text-center text-[10px] font-bold text-white/90 mb-2">
                            <div>DOM</div>
                            <div>SEG</div>
                            <div>TER</div>
                            <div>QUA</div>
                        ...
                        <div className="grid grid-cols-7 text-center gap-1">
                            {generateCalendarDays().map((dia, i) => {
                                ...
                                const possuiDesmontagem = locacoes?.some(
                                    (loc) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`py-3 rounded-xl text-sm transition-all cursor-pointer relative
                                            ${isHoje ? "border-white/50 border text-white font-bold" : "hover:bg-base text-slate-300"}
                                            
                                            ${
                                                possuiMontagem && !isHoje
                                                    ? "text-white border border-indigo-700/50"
                                                    : ""
                                            }
            ...
            {isDetailsOpen && selectedLoc && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
                    <div className="bg-base w-full max-w-md rounded-t-3xl sm:rounded-3xl border-t sm:border border-white/20 shadow-2xl animate-in slide-in-from-bottom duration-300">
                        <div className="p-6 border-b border-white/20 flex justify-between items-center">
                            ...
                            <button
                                ...
                                className="p-2 bg-base rounded-full hover:bg-slate-700 transition-colors"
                            >
                                <X size={20} />
                            </button>
                        </div>
                        ...
                        <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-base/50 p-4 rounded-xl border border-white/20 flex flex-col justify-center">
                                    <p className="text-[10px] text-white/90 uppercase font-bold mb-1 tracking-widest">
                                        Cliente
                                    </p>
                                ...
                                <div className="bg-base p-4 rounded-xl border border-white/20">
                                    <p className="text-[10px] text-white/90 uppercase font-bold mb-1 tracking-widest">
                                        Valor Total
                                    </p>
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-xs text-emerald-500/80 font-bold uppercase tracking-tighter">
                                                Enviar mensagem
                                            </span>
                                    ...
                                    <X
                                        size={18}
                                        className="text-emerald-500 -rotate-135"
                                    />
                                </a>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="bg-base/30 p-4 rounded-2xl border border-white/20">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <div className="flex-1 bg-red-800/20 border border-red-500/20 p-3 rounded-xl">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid gap-2">
                                    {selectedLoc.brinquedos.map((b, i) => (
                                        <div
                                            key={i}
                                            className="flex items-center gap-3 bg-base p-3 rounded-xl border border-white/20"
                                        >
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] text-white/90 uppercase">
                                                    Patrimônio: {b.id || "N/A"}
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div className="space-y-2 p-4 border-t border-white/20">
                            <h3 className="text-[10px] font-bold text-white/90 uppercase tracking-widest flex items-center gap-2">
                                <User size={14} /> Registro
                            </h3>
                            <div className="flex items-center gap-2">
                                <div className="bg-base/50 h-8 w-8 rounded-full flex items-center justify-center text-xs font-bold text-white border border-white/20">
                                    {selectedLoc.criado_por?.username
                                        ?.charAt(0)
                                        .toUpperCase() || "U"}
                                </div>
                                <div>
            ...
            {isDayModalOpen && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-60 p-4">
                    <div className="bg-base w-full max-w-sm rounded-3xl border border-white/20 shadow-2xl overflow-hidden">
                        <div className="p-6 border-b border-white/20 flex justify-between items-center bg-base/30">
                            ...
                            {locacoesDoDia.length > 0 ? (
                                locacoesDoDia.map((loc) => (
                                    <div
                                        ...
                                        className="p-3 bg-base border border-white/20 rounded-xl hover:border-white/40 transition-colors cursor-pointer"
                                    >
                                ...
                                <p className="text-center text-white/90 py-4">
